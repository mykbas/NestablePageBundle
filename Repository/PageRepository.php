...
namespace Mykbas\NestablePageBundle\Repository;
...
class PageRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function reorderElement($id, $parentId, $position)
    {
        ...
        // don't need to update old parent
        if ($old_parent_id != $parentId) {
            $old_children = $this->findBy(['parent' => $old_parent_id], ['sequence' => 'ASC']);
            $seq = 0;
        ...
        $new_children = $this->findBy(['parent' => $parentId], ['sequence' => 'ASC']);
        $seq = 0;
        ...
        foreach ($new_children as $nc) {
            ...
            if ($old_parent_id == $parentId) {
                ...
                $nr = $this->findBy(['sequence' => $position, 'parent' => $parentId]);
